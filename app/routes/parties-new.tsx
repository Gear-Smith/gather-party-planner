import type { Route } from "./+types/parties-new";
...
export default function PlanNewPartyRoute({ loaderData }: Route.ComponentProps) {
  return (
    <main className="flex min-h-[calc(100svh-7rem)] items-center justify-center px-4 py-8">
      <div className="w-full max-w-lg rounded-xl border p-6 shadow-sm">
        <h1 className="text-xl font-semibold">Plan a new party</h1>
